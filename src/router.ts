import { Percent, CurrencyAmount, Currency, validateAndParseAddress, TradeType } from '@telefy/teleswap-core-sdk'
import { Trade } from './entities/Trade'
import invariant from 'tiny-invariant'
import { RouteLeg } from '@telefy/teleswap-tines-sdk'
...
export abstract class Router {
  ...
  public static swapCallParameters(trade: Trade<Currency, Currency, TradeType>, options: TradeOptions): SwapParameters {
    ...
    const path: string[] = trade.route.legs.map((leg: RouteLeg) => leg.tokenTo.address)
